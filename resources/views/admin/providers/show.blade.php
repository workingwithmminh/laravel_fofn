...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-tools">
            ...
            <a href="{{ url('/provider-products/' . $provider->id . '/edit') }}" class="btn btn-primary btn-sm"><i
    ...
    <div class="box-body table-responsive no-padding">
        <table class="table table-striped">
            <tbody>
                <tr>
                    <th> {{ trans('theme::providers.name') }} </th>
                    <td> {{ $provider->name }} </td>
                </tr>
                <tr>
                    <th> {{ trans('theme::providers.production') }} </th>
                    <td> {{ $provider->production }} </td>
                </tr>
                <tr>
                    <th> {{ trans('theme::providers.origin') }} </th>
                    <td> {{ $provider->origin }} </td>
                </tr>
                <tr>
                    <th> {{ trans('theme::providers.url') }} </th>
                    <td> <a href="{{ url($provider->slug) }}">{{ url($provider->slug) }}</a></td>
                </tr>
                <tr>
                    <th> {{ trans('theme::providers.updated_at') }} </th>
