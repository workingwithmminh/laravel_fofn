...
<ol class="breadcrumb">
    ...
    <li class="active">{{ __('theme::providers.provider') }}</li>
</ol>
@endsection
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-tools">
            {!! Form::open(['method' => 'GET', 'url' => '/provider-products', 'class' => 'pull-left', 'role' =>
            'search']) !!}
            ...
            <a href="{{ url('/provider-products/create') }}" class="btn btn-success btn-sm"
        ...
        <table class="table table-striped">
            <tbody>
                <tr>
                    ...
                    <th>@sortablelink('name',trans('theme::providers.name'))</th>
                    <th>{{ trans('theme::providers.slug') }}</th>
                    <th class="text-center">{{ trans('theme::providers.active') }}</th>
                    <th>@sortablelink('updated_at',trans('theme::providers.updated_at'))</th>
                    <th></th>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ url('/provider-products/' . $item->id) }}" name="{{ __('message.view') }}"><button
                                class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i>
                                </button></a>
                        @endcan
                        @can('ProviderController@update') 
                        <a href="{{ url('/provider-products/' . $item->id . '/edit') }}"
