            ...
            <tr class="row {{ $errors->has('image') ? 'has-error' : ''}}">
                ...
                <td class="col-md-8 col-lg-9">
                    <div>
                        ...
                        <div class="imgprev-wrap" style="display:{{ !empty($category->image)?'block':'none' }}">
                            <input type="hidden" value="" name="img-hidden"/>
                            <img class="img-preview" src="{{ !empty($category->image)?asset($category->image):'' }}" alt="{{ trans('theme::news.image') }}"/>
...
{{--                <td class="col-md-4 col-lg-3">--}}
{{--                    {!! Form::label('keywords', trans('theme::categories.keywords'), ['class' => 'control-label'])--}}
{{--                        !!}--}}
{{--                </td>--}}
{{--                <td class="col-md-8 col-lg-9">--}}
...
<div class="box-footer">
    ...
    !!}
    <a href="{{ url('/admin/category-products') }}" class="btn btn-default">{{ __('message.close') }}</a>
</div>
