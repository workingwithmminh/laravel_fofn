...
<ol class="breadcrumb">
    ...
    <li><a href="{{ url('/bookings/payments') }}">{{ __('booking::payments.payment') }}</a></li>
...
<div class="box">
    ...
    {!! Form::open(['url' => '/bookings/payments', 'class' => 'form-horizontal', 'files' => true]) !!}

    @include('booking::payments.form')
